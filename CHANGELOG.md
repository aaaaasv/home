...
- Майстер додавання рослини питає лише те, без чого рослини не існує: назву й ритм поливу. Вид, місце й
  «коли востаннє поливали» більше не питаються — вид підказує фото, місце й решта редагуються на готовій
  картці, а перший полив записується її ж кнопкою. З упізнаванням це два дотики замість шести кроків
