...
from src.mqtt import air_conditioner, home_sensors, panel_light, plant_soil, power, presence, room_climate
...
LISTENER_REGISTRARS: tuple[ListenerRegistrar, ...] = (
    ...
    home_sensors.register_listeners,
    panel_light.register_listeners,
    plant_soil.register_listeners,
    presence.register_listeners,
